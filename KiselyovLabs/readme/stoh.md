...
3. Пока значение _Q_ не стабилизирутеся
![](http://latex.codecogs.com/svg.latex?%5Cleft%28%7CQ_%7Bprev%7D%20-%20Q%7C%20%3C%20%5Cfrac%7B1%7D%7B100%7D%5Cright%29)
и в выборке присутствуют неправильно разделенные объекты (с неположительным отступом),
 _повторять_:
...
В зависимости от <u>шага 3</u> алгоритм дает как точный, так и неточный ответ (если,
например, выборки невозможно разделить прямой).
